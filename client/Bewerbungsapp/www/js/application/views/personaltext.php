...
<h1 i18n="content.ApplicationContent">Bewerbungs-Inhalt</h1>
	...
	<ul class="nav nav-pills nav-justified">
		...
		<li><a href="#/introtxt" i18n="content.Letter">Anschreiben</a></li>
		  ...
		  <li class="active"><a href="#/abouttxt" i18n="content.Personal">Persönlicher Text</a></li>
	</ul>

	<div class="jumbotron">
		
		<h3 i18n="content.Personal">Persönlicher Text:</h3>
		<p i18n="content.PersonalDescription">Schreibe hier noch etwas über deine Person, deine Qualifikationen oder persönliche Einstellung</p>
	  ...
	  <div class="jumbotron">
	   ...
	   <button ng-click="setPersonalText(personaltext)" class="btn btn-default" i18n="general.SaveChanges">Änderungen speichern</button>
   	</div>
